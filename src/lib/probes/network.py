...
class NetworkProbe(BaseProbe):
    def __init__(self):
        ...
        super().__init__(BaseProbeConfiguration(
        ...
        self.logger.info(f"EXTERNAL DNS LATENCY WEIGHT: {self.app_config.presentation.weight_external_dns_latency * 100}%")
        self.logger.info(f"INTERNAL DNS LATENCY WEIGHT: {self.app_config.presentation.weight_internal_dns_latency * 100}%")
        ...
        self.logger.info(f"EXTERNAL DNS LATENCY THRESHOLD: {self.app_config.presentation.threshold_external_dns_latency}ms")
        self.logger.info(f"INTERNAL DNS LATENCY THRESHOLD: {self.app_config.presentation.threshold_internal_dns_latency}ms")
